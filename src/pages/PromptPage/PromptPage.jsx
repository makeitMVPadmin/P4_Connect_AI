          ...
          <div className="promptpage__middle-container">
            <div className="promptpage__middle-container__sub-container">
              <div className="promptpage__middle-container__coffeemug-container">
                <img className="promptpage__middle-container__coffeemug-img" alt="" src={CoffeeMugWithHat_happy} />
              </div>
              <div className="promptpage__middle-container__sub-container text-container">
                ...
                <div className="welcome-text">Our AI feature empowers you to achieve your professional goals through personalized accountability partnerships. By taking our quick matching quiz, you’ll be paired with a peer who complements your skills, and you both will work towards a common goal.</div>
                <div className="welcome-text">Click "Next" to get started on your journey to effective peer-to-peer accountability.</div>
              </div>
